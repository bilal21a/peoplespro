                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="designation_name" id="designation_name" required
                                    class="form-control" placeholder="should be unique">
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="rate_type" id="rate_type" class="selectpicker form-control"
                                        data-live-search="true" data-live-search-style="contains" title='Select Rate Type'>
                                        <option value="1">Paid Per Shift</option>
                                        <option value="2">Peace Rate</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rate_per_shift" id="rate_per_shift" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="overtime_rate" id="overtime_rate" class="form-control"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" name="ok_button" id="ok_button"
                        class="btn btn-danger">{{ trans('file.OK') }}'
                    </button>
